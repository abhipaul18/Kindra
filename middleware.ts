...
export function middleware(request: NextRequest) {
  ...
  const cspHeader = `
    ...
    img-src 'self' blob: data: https://*.supabase.co https://*.tile.openstreetmap.org https://images.unsplash.com https://*.googleusercontent.com https://contribution.usercontent.google.com;
